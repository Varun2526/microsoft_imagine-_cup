        ...
        <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
                ...
                <form onSubmit={handleLogin} className="space-y-5">
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-1.5">
                            ...
                            <a href="#" className="text-sm font-medium text-blue-700 hover:underline">Forgot password?</a>
                        </div>
                    ...
                    <div className="flex items-center gap-2">
                        <input type="checkbox" id="keep" className="rounded border-slate-300 text-blue-600 focus:ring-blue-500" />
                        <label htmlFor="keep" className="text-sm text-slate-600">Keep me signed in</label>
                    </div>
                ...
                <div className="mt-6 text-center">
                    <p className="text-sm text-slate-500">Need verification access? <span className="font-semibold text-slate-700">Contact Support</span></p>
                </div>
                <div className="mt-2 text-center">
                    <Link to="/register" className="text-sm font-medium text-blue-700 hover:underline">Create an account</Link>
                </div>
            </div>
